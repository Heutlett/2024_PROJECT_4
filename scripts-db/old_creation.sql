...
CREATE TABLE Table_Availability (
    ...
    Start_Time TIME,
    End_Time TIME,
    -- Should always be Start_Time + 2 hours
...
ADD CONSTRAINT FK_User_Type_Association_User FOREIGN KEY (Username) REFERENCES User_(Username);
ALTER TABLE User_Type_Association
ADD CONSTRAINT FK_User_Type_Association_User_Type FOREIGN KEY (Type_ID) REFERENCES User_Type(ID);